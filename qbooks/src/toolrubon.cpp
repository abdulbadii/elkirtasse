...
void toolrubon::tabWidget_currentChanged(int) { collapsTab(false); }
...
void toolrubon::setStyleWhite()
{
    ...
    QString mystyle = QString(
        ...
        "background-color: qlineargradient(spread:pad, x1:0.994318, "
        "y1:0.471, x2:1, y2:1, stop:0 rgba(%1, %2, %3, 50), stop:1 rgba(%1, "
        "%2, %3, 100));"
        "margin-bottom: -2px;"
        ...
        "background-color: qlineargradient(spread:pad, x1:0.994318, y1:1.0, "
        "x2:1, y2:0, stop:0 rgba(255, 255, 255, 80), stop:1 rgba(%1, %2, %3, "
        "160));"
        "}"
        ...
        "background-color: qlineargradient(spread:pad, x1:0.1, y1:0.0113636, "
        "x2:1, y2:0, stop:0 rgba(255, 255, 255, 80), stop:1 rgba(%1, %2, %3, "
        "160));"
        "}"
        ...
        "background-color: qlineargradient(spread:pad, x1:0.61, "
        "y1:0.0113636, x2:1, y2:0, stop:0 rgba(%1, %2, %3, 50), stop:1 "
        ...
        "margin-bottom: -2px;"
        "background-color: qlineargradient(spread:pad, x1:0.994318, "
        "y1:0.471, x2:1, y2:0, stop:0 rgba(%1, %2, %3, 50), stop:1 rgba(255, "
        "255, 255, 150));"
        "border-top-left-radius: 4px;"
        "border-top-right-radius: 4px;"
        ...
        "border-width: 0px;}"
                          ...
                          .arg(QString::number(mred))
                          .arg(QString::number(mgreen))
                          .arg(QString::number(mblue));
