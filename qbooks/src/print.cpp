...
Print::~Print() { }
void Print::setpathApp(QString path) { m_pathApp = path; }

void Print::setBookTitle(QString name) { m_bookTitle = name; }

void Print::setBookAuthor(QString name) { m_bookAuthor = name; }

void Print::setBookBetaka(QString name) { m_bookBetaka = name; }

void Print::setBookColorBack(QString name) { m_WebColorBack = name; }

void Print::setBookFont(QString name) { m_WebFont = name; }

void Print::setBookFontColor(QString name) { m_WebFontColor = name; }

void Print::setBookFontTitleColor(QString name) { m_WebFontTitleColor = name; }
...
void Print::setBookCurentPath(QString name) { m_curentPath = name; }

void Print::setBookFontTitle(QString name) { m_WebFontTitle = name; }
...
QString Print::convertText(QString txt, QString part, QString page, int id)
{
    ...
    if (ui->checkBox->isChecked()) {
        txt.insert(txt.length(),
            "<br><font size='1' ><p> __________الجزء : " + part + " /الصفحة : " + page + "__________</p></font><p align=\"right\"></p>");
        //   m_textEdit->insertHtml("<br><font size='1' ><p> __________الجزء :
        //   "+part+" /الصفحة : "+page+"__________</p></font><p
        //   align=\"right\"></p>");
    }
...
void Print::on_toolButton_clicked()
{
    ...
    QString dir = QFileDialog::getExistingDirectory(
        this, tr("Open Directory"), homeDir,
...
bool Print::creatEpubDIrectory()
{
    ...
    out2 << "body {direction: rtl; margin: 2%; background-color: #FEFBE7; }"
            ...
            "#book-container span.footnote-hr { font-size: 1px; display: block; "
            "width: 25%; border-bottom: 1px solid #665555; }"
            "#book-container span.matn-hr { font-size: 1px; display: block; "
            "width: 95%; border-bottom: 3px solid #000000; margin: 0pt auto; } "
            ".center { text-align:center;display:block; } .info-item { display: "
            "block; margin-bottom: 5px; } .info-title { display: inline-block; "
            "width: 25%; font-weight: bold; vertical-align: top; } .info-desc { "
...
bool Print::creatEpubContent()
{
    ...
    out << "<dc:identifier id=\"BookID\" "
           "opf:scheme=\"UUID\">urn:uuid:f38f5e73c5be19930ef2d0b440d52b34</"
           "dc:identifier>";
    out << "</metadata>";
    out << "<manifest>";
    out << "<item id=\"ncx\" href=\"toc.ncx\" "
           "media-type=\"application/x-dtbncx+xml\"/>";
    out << "<item id=\"stylesheet\" href=\"style.css\" media-type=\"text/css\"/>";
    out << "<item id=\"logo\" href=\"img/logo.png\" media-type=\"image/png\"/>";
    out << "<item id=\"info\" href=\"xhtml/info.xhtml\" "
           "media-type=\"application/xhtml+xml\"/>";

    for (int i = 0; i < rowsCount; i++) {
        QString txt = QString("<item id=\"P%1\" href=\"xhtml/P%1.xhtml\" "
                              "media-type=\"application/xhtml+xml\"/>")
...
bool Print::creatEpubToc()
{
    ...
    out << "<ncx xmlns=\"http://www.daisy.org/z3986/2005/ncx/\" "
           "version=\"2005-1\">";
    out << "<head>";
    out << "<meta name=\"dtb:uid\" "
           "content=\"f38f5e73c5be19930ef2d0b440d52b34\"/>";
...
QString Print::getChildNavpoint(QTreeWidgetItem* item)
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        txtNav.insert(txtNav.length(),
            "<navPoint id=\"C" + order + "\" playOrder=\"" + order + "\"><navLabel><text>" + txt + ".</text></navLabel><content src=\"xhtml/P" + id + ".xhtml\"/>");
        // child her----------------------------
...
bool Print::creatEpubInfo()
{
    ...
    // style=\"text-align:center; \" >"; out << "<div class=\"center\"><img
    // src=\"../img/logo.png\" style=\"margin:4px;\" alt=\""+elkirtasse+"\"
    // /></div> \n";
    //   out << "</td> </tr></table>";
    ...
    out << "<COL WIDTH=100%>";
    out << "<TR>";
    out << "<TD WIDTH=100% VALIGN=TOP STYLE=\"border: 1px solid #000000; "
           "padding: 0.1cm\">";
    out << "<P ALIGN=CENTER><IMG SRC=\"../img/logo.png\"  ALIGN=CENTER  "
           "BORDER=0>";
    out << "</P>";
    out << "</TD>";
    out << "</TR>";
...
//! [4]
//! [4] [0]
QString Print::convertEpubStyle(QString txt, QString part, QString page,
    int id)
{
    ...
    foreach (item, found) {
        ...
        txt.replace(item->text(0) + "<br />",
            "<span class=\"title\">" + item->text(0) + "</span><br />");
        txt.replace("  " + item->text(0),
            "<span class=\"title\">" + item->text(0) + "</span><br />");
        txt.replace("<br />" + item->text(0),
            "<span class=\"title\">" + item->text(0) + "</span><br />");
        txt.replace(item->text(0) + "<br />",
            "<span class=\"title\">" + item->text(0) + "</span><br />");
        txt.replace(item->text(0) + " <br />",
    ...
    if (txt.contains(rxi) || txt.contains(rxd)) {
        txt.replace(
            rxi,
            " <span class=\"footnote-hr\">&nbsp;</span><span class=\"footnote\">");
        txt.replace(
            rxd,
            "  <span class=\"footnote-hr\">&nbsp;</span><span class=\"footnote\">");
        hachia = true;
    ...
    txt.replace("صلى الله عليه وسلم",
        "<span class=\"prifired\">صلى الله عليه وسلم</span>");
    txt.replace("C تعالى", "<span class=\"prifired\">رحمه الله تعالى</span>");
    txt.replace("{", "<span class=\"prifired\">﴿</span>");
    txt.replace("}", "<span class=\"prifired\">﴾</span>");
    txt.replace("رضي الله عنهم ",
        "<span class=\"prifired\">رضي الله عنهم </span>");
    txt.replace("رضي الله عنه ", "<span class=\"prifired\">رضي الله عنه </span>");
    txt.replace("رضي الله عنهما ",
        "<span class=\"prifired\">رضي الله عنهما </span>");
    ...
    if (ui->checkBox->isChecked()) {
        ...
        txt.insert(txt.length(),
            "<br /><br /><br /><div class=\"center\">" + gg + "</div>");
        //   txt.insert(txt.length(),"<br><font size='1' ><p> __________ الجزء:
        //   "+part+" /الصفحة : "+page+"__________</p></font><p
        //   align=\"right\"></p>"); m_textEdit->insertHtml("<br><font size='1' ><p>
        //   __________الجزء : "+part+" /الصفحة : "+page+"__________</p></font><p
        //   align=\"right\"></p>");
    }
...
void Print::creatHtmlDocument(bool isQml)
{
    ...
    if (isQml == true) {
        ...
        if (dir.mkdir("content") == true) {
            ...
            file.copy(m_pathApp + "/data/qml/FlickableWebView.qml",
                ui->lineEdit->text() + "/" + m_bookTitle + "/content/FlickableWebView.qml");
            file.copy(m_pathApp + "/data/qml/Header.qml", ui->lineEdit->text() + "/" + m_bookTitle + "/content/Header.qml");
            file.copy(m_pathApp + "/data/qml/ScrollBar.qml",
                ui->lineEdit->text() + "/" + m_bookTitle + "/content/ScrollBar.qml");

            if (dir.mkdir("content/pics") == true) {
                file.copy(m_pathApp + "/data/qml/pics/titlebar-bg.png",
                    ui->lineEdit->text() + "/" + m_bookTitle + "/content/pics/titlebar-bg.png");
            }
            ...
            out << "import \"content\" \n";
            out << "Rectangle { \n";
            out << QString("  id: webBrowser ; property int countpage:%1;property "
                           "string urlString : \"index.html\"; width: 800; height: "
                           "600; color: \"#343434\" \n")
                       .arg(QString::number(rowsCount));
            out << "FlickableWebView {\n";
            out << "   id: webView ; url: webBrowser.urlString; onProgressChanged: "
                   "header.urlChanged = false; \n";
            out << "   anchors { top: headerSpace.bottom; left: parent.left; right: "
                   "parent.right; bottom: parent.bottom  } \n}\n";
            out << "Item { \n id: headerSpace; width: parent.width; height: 40 \n } "
                   "\n";
            out << "ScrollBar { \n";
            out << "  scrollArea: webView; width: 8 \n";
            out << "  anchors {  right: parent.right; top: header.bottom; bottom: "
                   "parent.bottom } \n} \n";
            out << "ScrollBar { \nscrollArea: webView; height: 8; orientation: "
                   "Qt.Horizontal \n";
            out << "  anchors { right: parent.right; rightMargin: 8; left: "
                   "parent.left; bottom: parent.bottom } \n} \n";
            out << "Header { \n  id: header; count:webBrowser.countpage \n";
            out << "  width: headerSpace.width; height: 40; anchors.top: parent.top; "
                   "anchors.topMargin: 0 } \n} \n";
        }
    }
        ...
        case QMessageBox::Ok:
            if (isQml == false) {
                QDesktopServices::openUrl(QUrl::fromLocalFile(
                    ui->lineEdit->text() + "/" + m_bookTitle + "/index.html"));
            } else {
                QDesktopServices::openUrl(QUrl::fromLocalFile(
                    ui->lineEdit->text() + "/" + m_bookTitle + "/index.qml"));
            }
            break;
        default:
...
bool Print::creatHtmlPages(bool isQml)
{
    ...
    for (int i = 0; i < rowsCount; i++) {
        ...
        QString txtContent1 = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\">"
            ...
            + fontname + "';" + fontHeight + " font-style:normal;\" " + bgr + "><font color='" + m_WebFontColor + "' >";
        ...
        QString bookPart = noeud.firstChildElement("part").firstChild().toText().data();
        QLocale lc(this->locale().name());
        QString TableImages = "<TABLE WIDTH=100% CELLPADDING=0 CELLSPACING=0  "
                              "STYLE=\"page-break-before: always\">"
                              "<TR VALIGN=TOP>"
                              "<TD WIDTH=26 HEIGHT=26 STYLE=\"; border: none; padding: 0cm\">"
                              "<P ALIGN=RIGHT><A HREF=\"P1.html\"><IMG SRC=\"img/first.png\" "
                              "NAME=\"first\" ALIGN=LEFT WIDTH=24 HEIGHT=24 BORDER=0></P></TD>\n"
                              "<TD WIDTH=26 STYLE=\"border: none; padding: 0cm\">"
                              "<P ALIGN=RIGHT><A HREF=\"P"
            + QString::number(prev) + ".html\"><IMG SRC=\"img/prev.png\" NAME=\"prev\" ALIGN=LEFT WIDTH=24 "
                                      "HEIGHT=24 BORDER=0></P></TD>\n"
                                      "<TD WIDTH=26 STYLE=\"border: none; padding: 0cm\">"
                                      "<P ALIGN=RIGHT><A HREF=\"../index.html\"><IMG SRC=\"img/home.png\" "
                                      "NAME=\"home\" ALIGN=LEFT WIDTH=24 HEIGHT=24 BORDER=0></P></TD>\n"
                                      "<TD WIDTH=26 STYLE=\"border: none; padding: 0cm\">"
                                      "<P ALIGN=RIGHT><A HREF=\"P"
            + QString::number(next) + ".html\"><IMG SRC=\"img/next.png\" NAME=\"next\" ALIGN=LEFT WIDTH=24 "
                                      "HEIGHT=24 BORDER=0></P></TD>\n"
                                      "<TD WIDTH=26 STYLE=\"border: none; padding: 0cm\">"
                                      "<P ALIGN=RIGHT><A HREF=\"P"
            + QString::number(rowsCount) + ".html\"><IMG SRC=\"img/last.png\" NAME=\"last\" ALIGN=LEFT WIDTH=24 "
                                           "HEIGHT=24 BORDER=0></P></TD>\n"
                                           "<TD WIDTH=100% STYLE=\"border: none; padding: 0cm\">"
                                           "<P ALIGN=CENTER>الجزء : "
            + lc.toString(bookPart.toInt()) + " / الصفحة : " + lc.toString(bookPage.toInt()) + "</P></TD>\n"
                                                                                               "</TR>"
                                                                                               "</TABLE>";
...
void Print::creatHtmlFahrassa(bool isQml)
{
    ...
    QString txtContent1 = "<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.0 Transitional//EN\">"
        ...
        + title + "</TITLE>"
                  "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"/>"
                  "</HEAD><body style=\" font-size:9pt; font-weight:400; "
                  "font-style:normal;\">\n"
                  "<p align=\"center\" style=\" margin-top:0px; margin-bottom:0px; "
                  "margin-left:0px; margin-right:0px; -qt-block-indent:0; "
                  "text-indent:0px;\"><img src=\"HTML/img/logo.png\" /></p>\n"
                  "<p align=\"center\" dir='rtl' style=\" margin-top:0px; "
                  "margin-bottom:0px; margin-left:0px; margin-right:0px; "
                  "-qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:18pt; "
                  "color:#ff0000;\">"
        + m_bookTitle + "</span></p>\n"
                        "<p align=\"center\" dir='rtl' style=\" margin-top:0px; "
                        "margin-bottom:0px; margin-left:0px; margin-right:0px; "
                        "-qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:16pt; "
                        "color:#ff0000;\">"
        + m_bookAuthor + "</span></p>\n"
                         "<p align=\"right\" dir='rtl' style=\" margin-top:0px; "
                         "margin-bottom:0px; margin-left:0px; margin-right:0px; "
                         "-qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:16pt; "
                         "\">"
        + convertTextBetaka(m_bookBetaka) + "</span></p>\n"
                                            "<p align=\"right\" dir='rtl' style=\" margin-top:0px; "
                                            "margin-bottom:0px; margin-left:0px; margin-right:0px; "
                                            "-qt-block-indent:0; text-indent:0px;\"><span style=\" font-size:14pt; "
                                            "color:#0055ff;\">فهرسة</span></p>\n";

    out << txtContent1;

    out << "<ul>";
    //<p align="right" dir='rtl' style=" margin-top:0px; margin-bottom:0px;
    // margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;"><a
    // href="www.gggh.cim"><span style=" text-decoration: underline;
    int countTop = treeviw->topLevelItemCount();
    ...
    for (int i = 0; i < countTop; i++) {
        ...
        QString id = item->data(1, 1).toString();
        QString txt = item->text(0);
        out << "<li><p align=\"right\" dir='rtl' style=\" margin-top:0px; "
               "margin-bottom:0px; margin-left:5px; margin-right:5px; "
               "-qt-block-indent:0; text-indent:0px;\">"
               "<a href=\"HTML/P"
                + id + ".html\"><span style=\" text-decoration: "
...
QString Print::getChildHtml(QTreeWidgetItem* item)
{
    ...
    for (int i = 0; i < count; i++) {
        ...
        QString txt = itemChild->text(0);
        txtNav.insert(txtNav.length(),
            "<li><p align=\"right\" dir='rtl' style=\" margin-top:0px; "
            "margin-bottom:0px; margin-left:0px; margin-right:0px; "
            "-qt-block-indent:0; text-indent:0px;\">"
            "<a href=\"HTML/P"
                + id + ".html\"><span style=\" text-decoration: "
