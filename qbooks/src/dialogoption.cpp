...
QFont Dialogoption::getFontName() { return fontName; }
...
QString Dialogoption::getFontTitleName() { return fontTitleName; }

void Dialogoption::setLayouDir(bool arg)
{
    ui->checkBoxLngLayou->setChecked(arg);
}
bool Dialogoption::getLayouDir() { return ui->checkBoxLngLayou->isChecked(); }
...
QString Dialogoption::getColorBack() { return colorBack; }
...
QString Dialogoption::getColorFont() { return colorFont; }
void Dialogoption::setFontTitleSize(QString arg) { fontTitleSize = arg; }
QString Dialogoption::getFontTitleSize() { return fontTitleSize; }
...
QString Dialogoption::getFontHachiaName() { return fontHachiaName; }
...
QString Dialogoption::getColorPrefer() { return colorPrefer; }
...
QString Dialogoption::getColorFind() { return colorFind; }
...
QString Dialogoption::getThemesStyle() { return themesStyle; }
void Dialogoption::setPathCostm(QString arg)
{
    pathCostm = arg;
    ui->lineEdit_costmPath->setText(pathCostm);
}
QString Dialogoption::getPathCostm() { return ui->lineEdit_costmPath->text(); }
...
QString Dialogoption::getCadreFolder() { return cadreFolder; }

void Dialogoption::setWebCadre(bool arg) { ui->checkBoxCadre->setChecked(arg); }
bool Dialogoption::getWebCadre() { return ui->checkBoxCadre->isChecked(); }

void Dialogoption::setIconsThemes(bool arg)
{
    ui->checkBoxThemes->setChecked(arg);
}
bool Dialogoption::getIconsThemes() { return ui->checkBoxThemes->isChecked(); }
void Dialogoption::setRecentNbr(int arg) { ui->spinBox_3->setValue(arg); }
int Dialogoption::getRecentNbr() { return ui->spinBox_3->value(); }
void Dialogoption::setLng(int arg) { ui->comboBoxLng->setCurrentIndex(arg); }
int Dialogoption::getLng() { return ui->comboBoxLng->currentIndex(); }
...
void Dialogoption::setIconSize(int s) { ui->spinBoxIconSize->setValue(s); }

int Dialogoption::getIconSize() { return ui->spinBoxIconSize->value(); }
...
void Dialogoption::on_toolButton_costmPath_clicked()
{
    ...
    QString dir = dlg.getExistingDirectory(this, tr("Open Directory"), homeDir,
...
void Dialogoption::on_toolButtonStyleCostum_clicked()
{
    QString fileName = QFileDialog::getOpenFileName(
        this, tr("Open File"), ui->lineEditStyleCostum->text(),
