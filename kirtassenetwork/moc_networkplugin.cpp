...
QT_MOC_LITERAL(1, 14, 10), // "execPlugin"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 8), // "loadFile"
QT_MOC_LITERAL(4, 35, 7), // "urlPath"
QT_MOC_LITERAL(5, 43, 11) // "pluginTitle"

    },
    "networkplugin\0execPlugin\0\0loadFile\0"
    "urlPath\0pluginTitle"
};
...
void networkplugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<networkplugin *>(_o);
        (void)_t;
        switch (_id) {
...
void *networkplugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "NetInterface"))
        return static_cast< NetInterface*>(this);
